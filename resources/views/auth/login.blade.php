...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset('https://eproc.jasatirta1.co.id/assets/images/logo-jasatirta-crop.png') }}">
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
                    ...
                    <div class="row flex-1 g-0">
                        <div class="col-lg-6 h-100 my-auto order-1 order-lg-0">
                            <div class="bg-white shadow-lg position-absolute translate-middle top-50 start-50 d-none d-lg-flex align-items-center justify-content-center rounded-circle"
                                ...
                                <img src="https://eproc.jasatirta1.co.id/assets/images/logo-jasatirta-crop.png"
                                    alt="" class="img-fluid">
                            </div>
                            <div class="creative-card-body card-body p-sm-5">
                                ...
                                <div class="mt-5 text-muted">
                                    ...
                                    <a href="auth-register-creative.html" class="fw-bold">Klik disini</a>
                                </div>
                            </div>
                        </div>
