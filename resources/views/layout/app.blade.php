                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid"
                                                src="{{ asset('duralux/assets/images/brand/shopify.png') }}" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid"
                                                src="{{ asset('duralux/assets/images/brand/app-store.png') }}" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid"
                                                src="{{ asset('duralux/assets/images/brand/figma.png') }}" alt="" />
                                        </div>
                                        <div>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('duralux/assets/images/avatar/2.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('duralux/assets/images/avatar/3.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('duralux/assets/images/avatar/4.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('duralux/assets/images/avatar/5.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('duralux/assets/images/avatar/6.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                ...
                                <div class="mb-3">
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('duralux/assets/images/brand/app-store.png') }}"
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('duralux/assets/images/brand/figma.png') }}"
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('duralux/assets/images/brand/facebook.png') }}"
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('duralux/assets/images/brand/github.png') }}"
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('duralux/assets/images/brand/paypal.png') }}"
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action">
                                <div class="hstack justify-content-between border border-dashed rounded-3 p-3 mb-3">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="{{ asset('duralux/assets/images/avatar/1.png') }}" alt=""
                                                class="img-fluid" />
                                        </div>
                                        <div>
                                ...
                                <div class="hstack justify-content-between border border-dashed rounded-3 p-3 mb-3">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="{{ asset('duralux/assets/images/avatar/2.png') }}" alt=""
                                                class="img-fluid" />
                                        </div>
                                        <div>
                                ...
                                <div class="hstack justify-content-between border border-dashed rounded-3 p-3 mb-3">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="{{ asset('duralux/assets/images/avatar/3.png') }}" alt=""
                                                class="img-fluid" />
                                        </div>
                                        <div>
                                ...
                                <div class="hstack justify-content-between border border-dashed rounded-3 p-3 mb-2">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="{{ asset('duralux/assets/images/avatar/4.png') }}" alt=""
                                                class="img-fluid" />
                                        </div>
                                        <div>
